...
## Algorithm
This will be a neural network that utilizes [Particle Swarm Optimization](https://en.wikipedia.org/wiki/Particle_swarm_optimization) to prevent local minima that the networks can get trapped in.